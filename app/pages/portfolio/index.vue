...
<template>
  <div>
    <div class="mx-auto max-w-7xl px-6 pt-36 md:pt-44">
      <!-- Cabecera -->
    ...
    <!-- Snapay — venture insignia, movido aquí desde el home (ver el
         docstring de PortfolioSnapaySpotlightSection.vue). Vive fuera del
         contenedor `max-w-7xl` de arriba/abajo porque el propio componente
         gestiona su ancho y su fondo a sangre completa; anidarlo habría
         duplicado el padding horizontal. Va antes de los controles/rejilla
         de Sanity porque es contenido fijo, no un caso más del listado. -->
    <PortfolioSnapaySpotlightSection />

    <div class="mx-auto max-w-7xl px-6 pb-24">
      <!-- Controles: búsqueda + filtro por industria -->
      <div v-if="!isMaintenance" class="flex flex-col gap-5 border-b border-hairline pb-6 lg:flex-row lg:items-center lg:justify-between">
