  ...
  <section class="relative z-10">
    <div class="mx-auto max-w-7xl px-6 pb-16 md:pb-32">
      <div class="glass soft mx-auto max-w-4xl rounded-[2.5rem] border border-white/10 p-12 text-center">
        <h3 class="text-2xl font-black text-white md:text-4xl">Interested in becoming a CorosDev partner?</h3>
        <p class="mx-auto mt-4 max-w-2xl text-sm text-white/60 md:text-base">
          We are always looking to grow our network of strategic technology, capital, and data allies.
        </p>
        <div class="mt-8">
          <a
            href="/#contact"
