  ...
  <section id="testimonials" class="relative overflow-hidden py-12 md:py-24">
    ...
    <div class="marquee-mask overflow-hidden">
      <div class="animate-marquee flex w-max gap-8 hover:[animation-play-state:paused]">
        ...
        >
          <div
            class="glass soft flex h-full flex-col justify-between rounded-3xl border border-hairline p-8 transition-all duration-500 group-hover:border-cobalt-500/50"
          >
            <div>
              ...
              <p class="italic leading-relaxed text-ink-muted">&ldquo;{{ testimonial.quote }}&rdquo;</p>
            </div>
            <div class="mt-8 flex items-center gap-4">
              <div class="h-8 w-1 rounded-full bg-cobalt-500" />
              <div>
                <p class="text-sm font-bold text-ink">{{ testimonial.name }}</p>
